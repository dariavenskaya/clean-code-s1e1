...
var editTask=function(){
    ...
    //If class of the parent is .incopmleted-tasks__edit-task
    if(containsClass){

        //switch to .incopmleted-tasks__edit-task
    ...
    //toggle .incopmleted-tasks__edit-task on the parent.
    listItem.classList.toggle("todo__edit-task");
};
...
//Mark task as incomplete.
    ...
    //Append the task list item to the #incopmleted-tasks__list.
    var listItem=this.parentNode;
    incompleteTaskHolder.appendChild(listItem);
    bindTaskEvents(listItem,taskCompleted);
}
